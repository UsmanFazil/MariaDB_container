...
func create(DBname string) {
	...
	WalletTable := "create table Wallets ( userid varchar(40), walletaddress varchar(120) , PRIMARY KEY (userid,walletaddress), FOREIGN KEY (userid) REFERENCES Users (userid) );"
	CoOrdinatesTable := "create table Coordinates ( UserID varchar(40) NOT NULL ,ContractID varchar(40) NOT NULL, name varchar(100), topcord INT(20), leftcord INT(20), FOREIGN KEY (ContractID) REFERENCES Contract (ContractID), FOREIGN KEY (UserID) REFERENCES Users (userid) );"
