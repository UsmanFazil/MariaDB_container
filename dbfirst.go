...
func create(DBname string) {
	...
	SignerTable := "create table Signer ( ContractID varchar(40),userID varchar (40),name varchar (40) NOT NULL,SignStatus varchar(40) NOT NULL, SignDate varchar(40), DeleteApprove bool NOT NULL,Message varchar(500),Access bool,PRIMARY KEY (ContractID,userID), FOREIGN KEY (ContractID) REFERENCES Contract (ContractID), FOREIGN KEY (userID) REFERENCES Users (userid) );"
